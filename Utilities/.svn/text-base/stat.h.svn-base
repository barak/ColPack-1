...
//*/
void toFileStatisticForGraph(string baseDir, string stat_output_suffix, bool stat_output_append=1, bool stat_refresh_list = false); //i.e. Symmetric Matrix, Hessian
void toFileStatisticForBipartiteGraph(string baseDir, string stat_output_suffix, bool stat_output_append=1, bool stat_refresh_list = false); //i.e. Matrix, Jacobian
