...
int main()
{
	...
	*/
	...
	jr2d->DirectRecover_SparseSolversFormat(g, *dp3_LeftCompressedMatrix, *dp3_RightCompressedMatrix, *uip3_SparsityPattern, ip2_RowIndex, ip2_ColumnIndex, dp2_JacobianValue);
	...
	displayVector(*dp2_JacobianValue, (*ip2_RowIndex)[rowCount] - 1 );
	Pause();
