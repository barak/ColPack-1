...
int main()
{
	...
	g->Coloring("SMALLEST_LAST", "ACYCLIC");
	...
	*ip1_ColorCount = *ip1_SeedColumnCount;
	...
	int i_arraySize = hr->IndirectRecover_SparseSolversFormat(g, *dp3_CompressedMatrix, *uip3_SparsityPattern, ip2_RowIndex, ip2_ColumnIndex, dp2_HessianValue);
