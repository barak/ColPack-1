...
int main()
{
	...
	*/
	...
	jr2d->DirectRecover_CoordinateFormat(g, *dp3_LeftCompressedMatrix, *dp3_RightCompressedMatrix, *uip3_SparsityPattern, ip2_RowIndex, ip2_ColumnIndex, dp2_JacobianValue);
